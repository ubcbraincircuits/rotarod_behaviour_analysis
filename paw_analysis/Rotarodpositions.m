...
myFiles = dir(fullfile(myDir,'*csv')); %gets all files 
for k = 1:length(myFiles)
  clearvars -except myDir myFiles k
...
%% Calculate foot height in 5s intervals
